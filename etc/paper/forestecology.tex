...
\caption{Compute growth of trees based on census data from the Smithsonian Conservation Biology Institute (SCBI).}\label{fig:scbi-trees}
\end{figure}
...
\caption{Add spatial information: Buffer region and spatial cross-validation blocks (1 through 4). All trees in the interior of the study region will be the focal trees whose growth will modeled.}\label{fig:scbi-spatial-information}
\end{figure}
