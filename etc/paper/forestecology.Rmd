...
The next step in the our analysis sequence is to add additional spatial information to our main data frame: defining a buffer region of trees as well as adding spatial cross-validation block information.
