...
authors: 
- name: Albert Y. Kim 
  thanks: "Albert Y. Kim is Assistant Professor, Statistical & Data Sciences, Smith College, Northampton, MA 01063 (e-mail: akim04@smith.edu). This work was not supported by any grant. The authors thank numerous colleagues and students for their support."
...
```{r bw-posterior-viz-beta0, out.width="50%", fig.cap="Posterior distribution of beta0."}
