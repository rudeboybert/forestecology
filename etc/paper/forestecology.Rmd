...
1. Fit model, make predictions, and visualize model results
...
ggplot() +
  geom_sf_text(data = growth_scbi, aes(label = foldID, col = buffer), alpha = 0.2) +
...
```{r scbi-posterior-viz, out.width="100%", fig.cap="Posterior distributions of all parameters for a subset of species."}
