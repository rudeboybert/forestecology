...
We demonstrate the `forestecology` package's features on two data sets, SCBI @bourg_initial_2013 and Big Woods Michigan @allen_michigan_2020, both part of ForestGEO @andersonteixeira_ctfs-forestgeo_2015.
