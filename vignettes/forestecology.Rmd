...
# Save crossvalidation spatial grid
...
```{r scbi-define-cv-folds, out.width="100%", fig.cap="Buffer region for SCBI study region."}
...
ggplot() +
  ...
  geom_sf(data = scbi_study_region, fill = "transparent") +
