...
bw_growth_df <-
  ...
  # Convert data frame to sf object DA note: should compute_growth do this??
...
We use the function `add_buffer_variable` to identifiy which trees are inside of a buffer region of size `max_dist`.
