...
We present an example analysis using the [Michigan Big Woods research plot
data](https://doi.org/10.7302/wx55-kt18) which is part of the Smithsonian
Institution's [Forest Global Earth Observatory
(ForestGEO)](https://forestgeo.si.edu/) global network of forest research sites.
