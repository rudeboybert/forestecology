...
Here I cheated `run_cv` to run the cross valididation for just two training set. It runs on the whole data set up just for `test = fold 23` and `test = fold 2`. Just to see how long it takes.
```{r}
tic()
...
Running just two folds took 5440 seconds. There are 28 folds. So running everything should take 5440 * 14 / 60 / 60 = 21 hours. 
