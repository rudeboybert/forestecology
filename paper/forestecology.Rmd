...
keywords:
- forest ecology, inter-species competition, tree growth, R, Rstats, tidyverse, sf, cross-validation, spatial statistics

bibliography: paper.bib
output: rticles::asa_article
link-citations: yes
header-includes:
- \usepackage{xcolor, soul, xspace, float, subfig, lineno, setspace}
- \linenumbers
---
...
A.Y.K. and D.N.A. conceived the ideas and coded most of the package in the early design stages. A.Y.K. led the writing of the manuscript. S.P.C. refactored much of the package's code in the later design stages to align with R and "tidy" programming best practices [@wickham_welcome_2019]. All authors contributed critically to the drafts and gave final approval for publication.
