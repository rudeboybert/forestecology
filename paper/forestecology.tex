...
contains the variables above. Lastly, the species variable \texttt{sp}
is automatically converted to a factor\footnote{In our spatial
...
TODO: enumerate what these variables are and say if they need exact
names
