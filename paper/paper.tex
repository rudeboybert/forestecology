...
\noindent%
{\it Keywords:} forest ecology, interspecific competition, neighborhood
competition, tree growth, R, ForestGEO, spatial cross-validation
\vfill
...
\NormalTok{growth\_scbi }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{foldID =}\NormalTok{ spatial\_block\_scbi}\SpecialCharTok{$}\NormalTok{foldID }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{factor}\NormalTok{())}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Associate each observation to a fold}
\NormalTok{spatial\_block\_scbi }\OtherTok{\textless{}{-}}
  \FunctionTok{spatialBlock}\NormalTok{(}
    \AttributeTok{speciesData =}\NormalTok{ growth\_scbi, }\AttributeTok{k =}\NormalTok{ n\_fold,}
    \AttributeTok{selection =} \StringTok{"systematic"}\NormalTok{, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi,}
    \AttributeTok{showBlocks =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{verbose =} \ConstantTok{FALSE}
\NormalTok{  )}
...
\NormalTok{mult\_dist\_comp }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{dist =} \FunctionTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, }\FloatTok{6.25}\NormalTok{, }\FloatTok{7.5}\NormalTok{, }\FloatTok{8.75}\NormalTok{, }\DecValTok{10}\NormalTok{),}
  \AttributeTok{rmse =} \DecValTok{0}
\NormalTok{)}

\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(mult\_dist\_comp}\SpecialCharTok{$}\NormalTok{dist)) \{}
\NormalTok{  comp\_dist }\OtherTok{\textless{}{-}}\NormalTok{ mult\_dist\_comp}\SpecialCharTok{$}\NormalTok{dist[i]}

\NormalTok{  growth\_scbi }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{add\_buffer\_variable}\NormalTok{(}\AttributeTok{size =}\NormalTok{ comp\_dist, }\AttributeTok{region =}\NormalTok{ study\_region\_scbi)}

\NormalTok{  focal\_vs\_comp\_scbi }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{create\_focal\_vs\_comp}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi, }\AttributeTok{id =} \StringTok{"stemID"}\NormalTok{, }\AttributeTok{comp\_x\_var =} \StringTok{"basal\_area"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{run\_cv}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi)}

\NormalTok{  mult\_dist\_comp}\SpecialCharTok{$}\NormalTok{rmse[i] }\OtherTok{\textless{}{-}}\NormalTok{ focal\_vs\_comp\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{rmse}\NormalTok{(}\AttributeTok{truth =}\NormalTok{ growth, }\AttributeTok{estimate =}\NormalTok{ growth\_hat) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pull}\NormalTok{(.estimate)}
\NormalTok{\}}
\end{Highlighting}
...
\NormalTok{focal\_vs\_comp\_ba }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{create\_focal\_vs\_comp}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi, }\AttributeTok{id =} \StringTok{"stemID"}\NormalTok{,}
        \AttributeTok{comp\_x\_var =} \StringTok{"basal\_area"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{run\_cv}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi)}

\NormalTok{focal\_vs\_comp\_agb }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{create\_focal\_vs\_comp}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi, }\AttributeTok{id =} \StringTok{"stemID"}\NormalTok{,}
        \AttributeTok{comp\_x\_var =} \StringTok{"agb"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{run\_cv}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi)}

\NormalTok{focal\_vs\_comp\_ba }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{rmse}\NormalTok{(}\AttributeTok{truth =}\NormalTok{ growth, }\AttributeTok{estimate =}\NormalTok{ growth\_hat) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pull}\NormalTok{(.estimate)}
\DocumentationTok{\#\# [1] 0.14}

\NormalTok{focal\_vs\_comp\_agb }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{rmse}\NormalTok{(}\AttributeTok{truth =}\NormalTok{ growth, }\AttributeTok{estimate =}\NormalTok{ growth\_hat) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pull}\NormalTok{(.estimate)}
\DocumentationTok{\#\# [1] 2.08}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{growth\_scbi\_sp }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi\_sp }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{foldID =}\NormalTok{ spatial\_block\_scbi}\SpecialCharTok{$}\NormalTok{foldID }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{factor}\NormalTok{())}
\NormalTok{growth\_scbi\_can\_pos }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi\_can\_pos }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{foldID =}\NormalTok{ spatial\_block\_scbi}\SpecialCharTok{$}\NormalTok{foldID }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{factor}\NormalTok{())}
...
\NormalTok{focal\_vs\_comp\_sp }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi\_sp }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{create\_focal\_vs\_comp}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi, }\AttributeTok{id =} \StringTok{"stemID"}\NormalTok{,}
        \AttributeTok{comp\_x\_var =} \StringTok{"basal\_area"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{run\_cv}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi)}

\NormalTok{focal\_vs\_comp\_can\_pos }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi\_can\_pos }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{create\_focal\_vs\_comp}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi, }\AttributeTok{id =} \StringTok{"stemID"}\NormalTok{,}
        \AttributeTok{comp\_x\_var =} \StringTok{"basal\_area"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{run\_cv}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi)}
...
\NormalTok{growth\_scbi }\OtherTok{\textless{}{-}}\NormalTok{ growth\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{foldID =}\NormalTok{ SpatialBlock\_scbi}\SpecialCharTok{$}\NormalTok{foldID }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{factor}\NormalTok{())}
...
\CommentTok{\# shuffles:}
\NormalTok{num\_shuffle }\OtherTok{\textless{}{-}} \DecValTok{49}

\CommentTok{\# Save results here}
\NormalTok{run\_time }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{observed\_RMSE }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{observed\_RMSE\_CV }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{shuffle\_RMSE }\OtherTok{\textless{}{-}} \FunctionTok{vector}\NormalTok{(}\StringTok{"list"}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{shuffle\_RMSE\_CV }\OtherTok{\textless{}{-}} \FunctionTok{vector}\NormalTok{(}\StringTok{"list"}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{filename }\OtherTok{\textless{}{-}} \FunctionTok{here}\NormalTok{(}\StringTok{"paper/simulation\_results/"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{str\_c}\NormalTok{(}\StringTok{"2021{-}03{-}03\_scbi\_"}\NormalTok{, num\_shuffle, }\StringTok{"\_shuffles"}\NormalTok{)}
...
\NormalTok{comp\_bayes\_lm\_scbi }\OtherTok{\textless{}{-}}\NormalTok{ focal\_vs\_comp\_scbi }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{comp\_bayes\_lm}\NormalTok{(}\AttributeTok{prior\_param =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{run\_shuffle =} \ConstantTok{FALSE}\NormalTok{)}
...
\CommentTok{\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-} Compute num\_shuffle permutation test statistics}
\NormalTok{shuffle\_RMSE\_CV }\OtherTok{\textless{}{-}} \FunctionTok{numeric}\NormalTok{(}\AttributeTok{length =}\NormalTok{ num\_shuffle)}

\CommentTok{\# Compute num\_shuffle permutation test statistics}
\ControlFlowTok{for}\NormalTok{ (j }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{num\_shuffle) \{}
    \CommentTok{\# Compute and save RMSE}
\NormalTok{    shuffle\_RMSE\_CV[j] }\OtherTok{\textless{}{-}}\NormalTok{ focal\_vs\_comp\_scbi }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{run\_cv}\NormalTok{(}\AttributeTok{comp\_dist =}\NormalTok{ comp\_dist, }\AttributeTok{blocks =}\NormalTok{ blocks\_scbi, }\AttributeTok{run\_shuffle =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{rmse}\NormalTok{(}\AttributeTok{truth =}\NormalTok{ growth, }\AttributeTok{estimate =}\NormalTok{ growth\_hat) }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{pull}\NormalTok{(.estimate)}

    \CommentTok{\# Status update}
    \FunctionTok{str\_c}\NormalTok{(}\StringTok{"Shuffle with permutation "}\NormalTok{, j, }\StringTok{" at "}\NormalTok{, }\FunctionTok{Sys.time}\NormalTok{()) }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{print}\NormalTok{()}
\NormalTok{\}}

\CommentTok{\# 5. Save results {-}{-}{-}{-}}
\NormalTok{clock }\OtherTok{\textless{}{-}} \FunctionTok{toc}\NormalTok{(}\AttributeTok{quiet =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{run\_time }\OtherTok{\textless{}{-}}\NormalTok{ clock}\SpecialCharTok{$}\NormalTok{toc }\SpecialCharTok{{-}}\NormalTok{ clock}\SpecialCharTok{$}\NormalTok{tic}

\NormalTok{model\_comp\_tbl }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{run\_time =}\NormalTok{ run\_time, }\AttributeTok{observed\_RMSE =}\NormalTok{ observed\_RMSE,}
    \AttributeTok{observed\_RMSE\_CV =}\NormalTok{ observed\_RMSE\_CV, }\AttributeTok{shuffle\_RMSE =}\NormalTok{ shuffle\_RMSE, }\AttributeTok{shuffle\_RMSE\_CV =}\NormalTok{ shuffle\_RMSE\_CV,}
\NormalTok{    )}
\FunctionTok{save}\NormalTok{(model\_comp\_tbl, }\AttributeTok{file =}\NormalTok{ filename }\SpecialCharTok{\%\textgreater{}\%}
