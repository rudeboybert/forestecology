...
if (getRversion() >= "2.15.1") {
  utils::globalVariables(
    c("dbh08", "dbh14", "family_phylo", "trait_group", "buffer",
      "code14", "species", "focal_ID", "ID", "spCode", "fold", "basal_area",
      "dbh", "focal_ID_neighbor", "focal_bw_ID", "comp_species", "comp_biomass",
      ...
      "geom_vline", "ggplot", "labs", "offset", "sim_ID", "str_c",
      "str_sub", "type", "value", "values", "codes", "date1", "date2",
      "x_dir", "y_dir", "predict", "posterior_param", "comp")
  )
}
